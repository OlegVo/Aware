...
const steps = [
    ...
    {
        text: 'В основе всех эмоций лежат физические ощущения, управляя которыми можно управлять своим эмоциональным состоянием. Фокус заключается в том, чтобы вовремя распознать свое состояние',
        color: 'rgb(252, 195, 41)',
        image: require('./assets/Interested_Man.png'),
    },
    {
        text: 'Aware будет тренером вашей осознанности. Вы будете получать напоминания-инструкции. Применяйте их на практике и возьмите свои эмоции под контроль',
        color: 'rgb(87, 163, 43)',
